...
moveLeftLoop (ListZipper Nil     x r) = let (x':.r') = reverse (x:.r)
...
moveRightLoop (ListZipper l x Nil)     = let (x':.l') = reverse (x:.l)
...
moveLeftN' n z =
    let moveLeftN'' n' z' q | n' == 0   = Right z'
...
moveRightN' n z =
    let moveRightN'' n' z' q | n' == 0 = Right z'
