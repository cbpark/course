...
convertInteractive = putStr "Enter a string to upper case: " >-
...
encodeInteractive = let encode url = url >>= \c -> case c of
                                                       ' '  -> "%20"
                                                       '\t' -> "%09"
                                                       '"'  -> "%22"
                                                       _    -> c :. Nil
                    in putStr "Enter a URL to encode: " >-
                       getLine >>= \l -> putStrLn (encode l) >-
                                         putStrLn ""
